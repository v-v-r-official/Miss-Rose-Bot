...
im a group manager bot maintained by @VKprojects
...
It took lots of work for [my CHANNEL](t.me/VKPROJECTS) to get me to where I am now, and every donation helps \
motivate CHANNEL to make me even better. [Discuss Group](t.me/VKP_BOTS."""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 254318997 and DONATION_LINK:
            update.effective_message.reply_text("You can also Join On My Discuss Group "
